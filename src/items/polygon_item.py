...
from PySide6.QtGui import QPolygonF, QBrush, QPen, QColor, QPainter, QPainterPath
import math
import json
    ...
    def mousePressEvent(self, event):
        ...
        if event.button() == Qt.LeftButton and self.is_closed:
            ...
            for vertex in self.vertices:
                ...
                distance = math.sqrt((pos.x() - vertex_center.x())**2 + 
...
# 示例使用
def save_polygons_to_labelme_format(polygons, image_path, image_data, image_height, image_width):
    """
